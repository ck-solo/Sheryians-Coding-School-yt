...
const RightContent = () => {
  return (
    <div>
         <div className='bg-[url("https://img.freepik.com/free-photo/woman-holding-statistics-front-view_23-2149636315.jpg")] bg-cover bg-center h-[80vh]  px-10 flex flex-col justify-between rounded-2xl'></div>
